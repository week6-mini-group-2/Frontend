...
const Category = () => {
  ...
  return (
    <Swiper
      ...
      modules={[Pagination]}
      className="mySwiper">
      <SwiperSlide value="1" onClick={(e) => setCategory(e.target.value)}>
        <StTitle>플로깅</StTitle>
        <img
      ...
      <SwiperSlide value="2" onClick={(e) => categorySelect()}>
      ...
      <SwiperSlide value="3" onClick={categorySelect}>
      ...
      <SwiperSlide value="4" onClick={categorySelect}>
      ...
      <SwiperSlide value="5" onClick={categorySelect}>
      ...
      <SwiperSlide value="6" onClick={categorySelect}>
